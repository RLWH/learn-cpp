...
/**
 * @brief Encapsulating the vector of students into a single class
 * @details We are encapsulating adding students, calculating
 *          GPAs, and other procedures into this class, so the main.cpp
 *          script will become more clean. 
 * 
 */
...
public:
    // Functions that add elements into vectors
